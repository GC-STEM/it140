...
readonly IT140_USAGE="Usage: install_ide.zsh [--help] [--version] [--noninteractive] [--profile macos_bare_metal]"
...
Usage: install_ide.zsh [--help] [--version] [--noninteractive] [--profile macos_bare_metal]
...
if it140_command_line_tools_available; then
    ...
    if [ "$IT140_NONINTERACTIVE" -eq 1 ]; then
        it140_fail 6 "Apple Command Line Tools are required. Run 'xcode-select --install', complete Apple's installer, and rerun install_ide.zsh."
    fi
    ...
    it140_notice "Complete Apple's installer, then rerun install_ide.zsh."
    exit 6
fi
...
it140_notice "Next step: close this Terminal window, open a new Terminal window, and run configure_ide.zsh."
it140_closing_notice
exit 0
